...
public interface RuleSet {
	 ...
	 * @return - this RuleSet
	 */
	RuleSet init(InternalKnowledgeBase base, String ruleName);
	 ...
	 * 
	 * @throws RuntimeRuleException
	 *             - if an error occurred running the rule
	 */
	 ...
	 *            - the object to clear
	 * @throws RuntimeRuleException
	 *             - if an error occurred clearing the object
	 */
	 ...
	 * 
	 * @throws RuntimeRuleException
	 *             - if an error occurred clearings the objects
	 */
