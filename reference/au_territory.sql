CREATE VIEW DATA_CALL.VIEW_ANNUAL_AU_TERRITORY_2013
AS select q.state_code, q.state_name, q.territory_key, q.year, --q.accounting_year,
...
group by q.state_code, q.state_name, q.territory_key, q.year, --q.accounting_year,
         case when q.coverage_code = '1' then 'Bodily Injury'
              when q.coverage_code = '2' then 'Property Damage'
              when q.coverage_code = '3' then 'Single BI/PD Limit'
              when q.coverage_code = '4' then 'PIP'
